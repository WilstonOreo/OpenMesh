...
**
** Created: Mon Jul 2 13:13:50 2012
...
static const char qt_meta_stringdata_DecimaterViewerWidget[] = {
    "DecimaterViewerWidget\0\0animate()\0"
};
...
const QMetaObjectExtraData DecimaterViewerWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DecimaterViewerWidget::staticMetaObject = {
    { &MeshViewerWidget::staticMetaObject, qt_meta_stringdata_DecimaterViewerWidget,
      qt_meta_data_DecimaterViewerWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DecimaterViewerWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DecimaterViewerWidget))
        return static_cast<void*>(const_cast< DecimaterViewerWidget*>(this));
